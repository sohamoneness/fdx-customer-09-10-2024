...
public class CustChoiceOrderAdapter extends RecyclerView.Adapter<CustChoiceOrderAdapter.Hold> {
    ...
    public CustChoiceOrderAdapter(DashboardHome dashboardHome, List<RestaurantModel> nearbyRestList) {
...
//        Glide.with(context).load(nbrM.image)
//                .apply(new RequestOptions().placeholder(R.drawable.pop_rest_demo_img).error(R.drawable.pop_rest_demo_img))
//                .into(holder.ivRest);

...
public class OrderHistAdapter extends RecyclerView.Adapter<OrderHistAdapter.Hold> {
   ...
   // List<OrderItemModel> oiList;
    ...
    public OrderHistAdapter(OrderHistory orderHistory, List<OrderHistoryListModel> orderHistList) {
    ...
    @NonNull
    @Override
    public OrderHistAdapter.Hold onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //View mView = LayoutInflater.from(parent.getContext()).inflate(R.layout.order_hist_row, parent, false);
        View mView = LayoutInflater.from(parent.getContext()).inflate(R.layout.inflate_order_history, parent, false);
        return new Hold(mView);
    }

    @Override
    public void onBindViewHolder(@NonNull OrderHistAdapter.Hold holder, int position) {
...
//        }
        ...
        if (ohm.status.equals("1")){
            ...
            holder.orderStatus.setTextColor(context.getResources().getColor(R.color.white));

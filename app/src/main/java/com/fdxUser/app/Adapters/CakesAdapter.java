...
public class CakesAdapter extends RecyclerView.Adapter<CakesAdapter.Hold> {
    ...
    public CakesAdapter(DashboardHome dashboardHome, List<RestaurantModel> nearbyRestList) {

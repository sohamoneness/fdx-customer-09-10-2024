...
public class OfferForYouAdapter extends RecyclerView.Adapter<OfferForYouAdapter.Hold> {
    ...
    public OfferForYouAdapter(DashboardHome dashboardHome, List<RestaurantModel> nearbyRestList) {
    ...
    public class Hold extends RecyclerView.ViewHolder {
        ...
        TextView tvRestName, tvRestAdr, tvTime, tvDist, tvRating, tvOrderStat;
        // RatingBar ratingBar;

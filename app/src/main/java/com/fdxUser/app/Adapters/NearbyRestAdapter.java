...
public class NearbyRestAdapter extends RecyclerView.Adapter<NearbyRestAdapter.Hold> {
    ...
    public NearbyRestAdapter(Dashboard dashboard, List<RestaurantModel> nearbyRestList) {
        this.context = dashboard;
        this.nbList = nearbyRestList;

    }

    public NearbyRestAdapter(ShowAllScreen showAllScreen, List<RestaurantModel> allNearbyRestList) {
        this.context = showAllScreen;
        this.nbList = allNearbyRestList;
    }

    public NearbyRestAdapter(DashboardHome dashboardHome, List<RestaurantModel> nearbyRestList) {
        this.context = dashboardHome;
        this.nbList = nearbyRestList;
    }

    public NearbyRestAdapter(SearchActivity searchActivity, List<RestaurantModel> nearRestList) {
        this.context = searchActivity;
        this.nbList = nearRestList;
    }
    ...
    public void onBindViewHolder(@NonNull Hold holder, int position) {
        ...
        //Log.d("name>>",nbrM.name);
       // Log.d("desc>>",nbrM.description);
        try{

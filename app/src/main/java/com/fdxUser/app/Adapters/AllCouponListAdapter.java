...
public class AllCouponListAdapter extends RecyclerView.Adapter<AllCouponListAdapter.Hold> {

    Context context;
    List<CouponListModel> cList;

    public AllCouponListAdapter(AllCouponsActivity couponActivity, List<CouponListModel> couponList) {
    ...
    @NonNull
    @Override
    public AllCouponListAdapter.Hold onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View mView = LayoutInflater.from(parent.getContext()).inflate(R.layout.inflate_all_coupon_list, parent, false);
        return new AllCouponListAdapter.Hold(mView);
    }

    @Override
    public void onBindViewHolder(@NonNull AllCouponListAdapter.Hold holder, int position) {

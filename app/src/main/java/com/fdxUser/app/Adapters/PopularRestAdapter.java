...
public class PopularRestAdapter extends RecyclerView.Adapter<PopularRestAdapter.Hold> {
    ...
    public PopularRestAdapter(Dashboard dashboard, List<RestaurantModel> nearbyRestList) {
        this.context = dashboard;
        this.popList = nearbyRestList;
    }

    public PopularRestAdapter(ShowAllScreen showAllScreen, List<RestaurantModel> allNearbyRestList) {
        this.context = showAllScreen;
        this.popList = allNearbyRestList;
    }

    public PopularRestAdapter(DashboardHome dashboardHome, List<RestaurantModel> nearbyRestList) {
    ...
    public void onBindViewHolder(@NonNull Hold holder, int position) {
       ...
       // holder.specialRv.setLayoutManager(new GridLayoutManager(context, 5));
        ...
        Log.d(nbrM.name+" rate>>",nbrM.rating);
    ...
    public class Hold extends RecyclerView.ViewHolder {
        ...
        TextView tvPopRestName, tvPopRestAddress, tvEstTime, tvRating, tvDist, tvCuisines;
